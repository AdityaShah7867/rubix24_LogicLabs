...
const Footer = () => {
    return (
        ...
        <div><footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-5 px-5 border-top">
            <div class="col mb-3">
                <a href="/" class="d-flex align-items-center mb-3 link-dark text-decoration-none">
                    {/* <svg class="bi me-2" width="40" height="32"><use xlink:href="#bootstrap"></use></svg> */}
                    <Link to='/'>
                        <img src={logo} style={{ width: "150px" }} className='' />
                    </Link>
                </a>
                <ul class="nav col-md-4 list-unstyled d-flex">
                    ...
                    <li class="ms-3"><a class="text-muted" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 50 50">
            ...
            <p class="text-muted mx-auto mt-2">© 2024</p>
